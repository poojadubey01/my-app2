...
function Hero() {
  ...
  return (
    <>
      ...
      {/* Mobile View *
      <section
        className="block md:hidden relative md:h-full h-[65vh] bg-black pb-30 text-white p-8 flex flex-col justify-center items-center text-center"
        style={{
...
function Hero() {
  ...
  return (
    <>
      {/* Desktop/Tablet View */}
      <section className="relative h-screen flex flex-col justify-center items-center animate-fadeIn p-0 hidden md:block">
        ...
        {/* Content Overlay Div */}
        <div className="relative z-20 flex flex-col justify-center items-center text-center w-full h-full">
          {/* Text Content */}
          <div className="max-w-screen-md mx-auto px-4 py-8 w-full">
            <p className="mb-4 text-blue-400 text-xs font-medium">
              Introducing Linear Mobile
            </p>
